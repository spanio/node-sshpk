...
declare namespace SshPK {
  ...
  function parseKey(data: string|Buffer, format?: string, options?: any): Promise<Key>;
  ...
  function parsePrivateKey(data: string|Buffer, format: string, options?: any): Promise<PrivateKey>;

  function parseCertificate(data: string|Buffer, format: string, options?: any): Certificate;
  function createSelfSignedCertificate(subjectOrSubjects: string, key: Key, options?: any): Promise<Certificate>;
  function createCertificate(
    subjectOrSubjects: string, key: Key, issuer: string,
    issuerKey: PrivateKey, options?: any): Promise<Certificate>;
